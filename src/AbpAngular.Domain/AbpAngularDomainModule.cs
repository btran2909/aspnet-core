            ...
            Configure<NewsletterOptions>(options =>
            {
                options.AddPreference(
                    ...
                    new NewsletterPreferenceDefinition(
                        LocalizableString.Create<AbpAngularResource>("NewsletterPreference_Default"),
                        privacyPolicyConfirmation: LocalizableString.Create<AbpAngularResource>("NewsletterPrivacyAcceptMessage")
                    )
                );
            });
