...
{
    public class AbpAngularTenantDatabaseMigrationHandler :
        ...
        ITransientDependency
    {
        ...
        private readonly ILogger<AbpAngularTenantDatabaseMigrationHandler> _logger;

        public AbpAngularTenantDatabaseMigrationHandler(
            IEnumerable<IAbpAngularDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<AbpAngularTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? AbpAngularConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? AbpAngularConsts.AdminPasswordDefaultValue
            );
        }
