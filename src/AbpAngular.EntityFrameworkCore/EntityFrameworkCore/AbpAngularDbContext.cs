...
namespace AbpAngular.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See AbpAngularMigrationsDbContext for migrations.
     */
    ...
    public class AbpAngularDbContext : AbpDbContext<AbpAngularDbContext>
    {
         ...
         * Also map them inside AbpAngularDbContextModelCreatingExtensions.ConfigureAbpAngular
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the AbpAngularEfCoreEntityExtensionMappings class.
                 */
            });
