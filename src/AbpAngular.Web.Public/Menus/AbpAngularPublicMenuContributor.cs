...
namespace AbpAngular.Web.Public.Menus
{
    public class AbpAngularPublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public AbpAngularPublicMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<AbpAngularResource>();

            // Home
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    AbpAngularPublicMenus.HomePage,
                    l["Menu:HomePage"],
                    "~/",
                    icon: "fa fa-home",
                    order: 1
            ...
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    AbpAngularPublicMenus.ArticleSample,
            ...
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    AbpAngularPublicMenus.ContactUs,
                    l["Menu:ContactUs"],
                    "~/contact-us",
                    icon: "fa fa-phone",
                    order: 3
