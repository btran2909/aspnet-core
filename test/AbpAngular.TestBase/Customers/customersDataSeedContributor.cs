...
namespace AbpAngular.Customers
{
    public class customersDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public customersDataSeedContributor(IcustomerRepository customerRepository)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            (
                id: Guid.Parse("445b88d4-9793-4011-b8e5-4876e2584ffa"),
                licenseNo: "d4cfa64fe1fd41c3903c894c38c9769e4335c63d9c2e43ebb7e6dc618192ba4a9e0527f2",
                licenseExpired: new DateTime(2003, 2, 21),
